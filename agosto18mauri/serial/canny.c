...
int main(int argc, char *argv[])
{
        ...
        ****************************************************************************/
        sprintf(outfilename, "imagen-serial.pgm");
                     ...
                     short int **smoothedim)
{
        ...
        ****************************************************************************/
        ...
        // #pragma omp parallel default(shared) private(r,c,rr,cc,dot,sum)
        // {
        /****************************************************************************
        ...
        ****************************************************************************/
        ...
        printf("(gussian_smooth) %.4g segundos\n", (time_in_seconds));
        // printf("(gussian_smooth) %.4g segundos\n", (time_in_seconds));
}
